...
def get_class_num():
  x=len(glob.glob("/content/based_image_data/*"))
  if x==0:
    x=10
  return x
...
class SphereFace(Layer):
    def __init__(self, n_classes=get_class_num(), s=30.0, m=1.35, regularizer=None, **kwargs):
...
class CosFace(Layer):
    def __init__(self, n_classes=get_class_num(), s=30.0, m=0.35, regularizer=None, **kwargs):
